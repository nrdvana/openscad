...
QString MainWindow::exportPath(const char *suffix) {
  ...
  if (path_it != export_paths.end()) path = path_it->second;
  else if (this->fileName.isEmpty()) path = QString(PlatformUtils::userDocumentsPath().c_str()) + QString(_("/Untitled")) + suffix;
  else {
